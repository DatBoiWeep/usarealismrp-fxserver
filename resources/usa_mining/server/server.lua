...
local common = {
    {name = "Bauxite", type = "misc", price = 150, legality = "legal", quantity = 1, weight = 5.0},
    {name = "Copper", type = "misc", price = 100, legality = "legal", quantity = 1, weight = 10.0},
...
local rare = {
    {name = "Diamond", type = "misc", price = 650, legality = "legal", quantity = 1, weight = 15.0},
    {name = "Gold", type = "misc", price = 550, legality = "legal", quantity = 1, weight = 15.0},
    {name = "Crude Oil", type = "misc", price = 300, legality = "legal", quantity = 1, weight = 15.0},
}
