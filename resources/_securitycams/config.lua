...
SecurityCamConfig.Locations = {
    ...
    {
        camBox = {label = "Vespucci Beach Strip", id = 'vbeach'},
        cameras = {
            {label = "SW Beach View - A4 Store", x = -1266.1480712891, y = -1432.3841552734, z = 12.622509002686, r = {x = -30.0, y = 0.0, z = 157.4}},
            {label = "SW Beach View - B4 Store", x = -1247.5299072266, y = -1458.2331542969, z = 11.600588798523, r = {x = -30.0, y = 0.0, z = 155.3}},
            {label = "SW Beach View - F4 Store", x = -1202.0642089844, y = -1523.3083496094, z = 12.016693115234, r = {x = -30.0, y = 0.0, z = 165.8}},
            {label = "Main Middle Area - D1", x = -1199.3397216797, y = -1451.4779052734, z = 9.9735517501831, r = {x = -30.0, y = 0.0, z = 97.5}},
            {label = "East Parking Lot", x = -1211.6689453125, y = -1476.3787841797, z = 11.871105194092, r = {x = -30.0, y = 0.0, z = 244.6}},
            {label = "West Parking Lot", x = -1243.0007324219, y = -1443.1854248047, z = 12.313669204712, r = {x = -30.0, y = 0.0, z = 349.3}}
