...
svConfig = {
    ...
    competitionMinMoneyPerMinute = 1500,
    competitionMaxMoneyPerMinute = 5000,
    ...
    competitionSchedule = {
        ...
        { -- EU / NA Time
            ...
            startHour = 11,
            startMinute = 0 -- Races start at [11AM PST | 2PM EST]
        },
        { -- NA (EST) Time
            generationHour = 14,
            generationMinute = 0,
        ...
        { -- NA (PST) Late
            ...
            startHour = 21,
            startMinute = 0 -- Races start at [9PM PST | 12AM EST]
        }
    },
    ...
    maximumGeneratedCompetitions = math.random(6,10),
    ...
    competitionCreationRequiredElo = 1750,
