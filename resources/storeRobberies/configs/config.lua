...
Config.Framework = "NONE" --Set this between "ESX" or "QBUS" or "VRP" or "NONE"
...
Config.ShopkeeperResetTime = 1000 * 60 * 300 --ShopKeeper reset timer. Default is 30 minutes, so every 30 minutes the shopkeeper at every shop changes. Just to make it look unique.
...
Config.UseItems = true --Enable this to enable items checking. "advancedlockpick".
Config.GlobalCooldownShop = false -- Set this to true if you want a global cooldown at the shops on one robbery.
--IMPORTANT STUFF--


--CONTROLS--
Config.EmptyRegisterButton = 185 -- F.
Config.DisableCamerasButton = 74 --Default is 74 (H).
Config.LockpickRegisterButton = 185 -- F.
Config.SafeButton = 185 -- F.
--CONTROLS--

Config.PedRegisterOpenTimeMs = 25 * 1000
...
Config.Shops = {
    [1] = {
        ...
        registerMoney = {100, 1000}, --The money you can get from the register, from low to high.
        safeCoords = vector3(-43.92, -1748.08, 29.42),
        safeMoney = {1000, 10000}, --The money you can get from the safe, from low to high.
        safeType = "keypad", --Type of safe. 2 options: "keypad" and "padlock"
        safeCode = nil, --Don't touch.
        cooldown = {hour = 2, minute = 0, second = 0}, --Cooldown till the shop resets.
    ...
    [12] = {
        ...
        shopKeeperState = nil, --Don't touch.
        shoperKeeperSpawned = false, --Don't touch.
        registerCoords = vector3(-3242.22, 100.53, 12.68), --The register's coords.
        registerMoney = {100, 1000}, --The money you can get from the register, from low to high.
