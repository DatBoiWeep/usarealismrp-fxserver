local ITEMS = {
    ...
    -- BURGER SHOT ITEMS
    { name = "Money Shot Burger", price = 500, type = "food", substance = 90.0, quantity = 1, legality = "legal", weight = 5, objectModel = "prop_cs_burger_01" },
    { name = "The Bleeder Burger", price = 375, type = "food", substance = 70.0, quantity = 1, legality = "legal", weight = 5, objectModel = "prop_cs_burger_01" },
    { name = "Torpedo Sandwich", price = 375, type = "food", substance = 70.0, quantity = 1, legality = "legal", weight = 5, objectModel = "prop_sandwich_01" },
    { name = "Meat Free Burger", price = 375, type = "food", substance = 70.0, quantity = 1, legality = "legal", weight = 5, objectModel = "prop_cs_burger_01" },
    { name = "French Fries", price = 175, type = "food", substance = 65.0, quantity = 1, legality = "legal", weight = 5, objectModel = "prop_food_bs_chips" },
    ...
    { name = "Moon Mochi", price = 250, type = "food", substance = 40.0, quantity = 1, legality = "legal", weight = 1},
    --{ name = "Senpai Combo", price = 550, type = "food", substance = 90.0, quantity = 1, legality = "legal", weight = 3, objectModel = "prop_donut_01"},
    { name = "Buddha Bowl", price = 500, type = "food", substance = 85.0, quantity = 1, legality = "legal", weight = 2, objectModel = "prop_cs_bowl_01b"},
    { name = "Bento Box", price = 500, type = "food", substance = 90.0, quantity = 1, legality = "legal", weight = 3, objectModel = "v_res_fa_shoebox4"},
    --{ name = "Mini Licious Box", price = 100, type = "food", substance = 85.0, quantity = 1, legality = "legal", weight = 3, objectModel = "prop_food_cb_nugets"},
    --{ name = "Coffee", price = 25, type = "drink", substance = 45.0, quantity = 1, legality = "legal", weight = 1, objectModel = "p_amb_coffeecup_01"},
    --{ name = "Alex's Special", price = 100, type = "drink", substance = 85.0, quantity = 1, legality = "legal", weight = 2, objectModel = "v_res_mcofcup"},
    --{ name = "Rainbow Glitter Frappuccino", price = 100, type = "drink", substance = 85.0, quantity = 1, legality = "legal", weight = 2, objectModel = "p_amb_coffeecup_01"},
    { name = "Espresso", price = 350, type = "drink", substance = 80.0, quantity = 1, legality = "legal", weight = 1, objectModel = "p_amb_coffeecup_01"},
    { name = "Macchiato", price = 350, type = "drink", substance = 80.0, quantity = 1, legality = "legal", weight = 1, objectModel = "v_res_mcofcup"},
    { name = "Latte", price = 350, type = "drink", substance = 80.0, quantity = 1, legality = "legal", weight = 1, objectModel = "v_res_mcofcup"},
    { name = "Mocha", price = 350, type = "drink", substance = 80.0, quantity = 1, legality = "legal", weight = 2, objectModel = "v_res_mcofcup"},
    { name = "Blueberry Bubble Tea", price = 350, type = "drink", substance = 80.0, quantity = 1, legality = "legal", weight = 1, objectModel = "ng_proc_sodacup_01c"},
    --[[
