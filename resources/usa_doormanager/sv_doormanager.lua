...
local DOORS = {
  ...
  -- DavisPD MLO (Not Gabz)
  {name = "DavisPD_ParkingLot_EntranceGate", x = 368.29309082031, y = -1582.5556640625, z = 29.29176902771, model = 1286535678, locked = true, _dist = 8.0, gate = true, offset={3.0, -2.5, 2.0}, lockedCoords = {365.63354492188, -1580.4565429688, 30.371784210205}, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_BriefRoom_LeftDoor", x = 377.45, y = -1598.03, z = 29.75, model = -1550418369, locked = true, offset={0.0, 0.8, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_BriefRoom_RightDoor", x = 378.73, y = -1596.51, z = 29.75, model = -1550418369, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {"sheriff","corrections"}, static = true,},
  {name = "DavisPD_BriefRoom_SideDoor", x = 373.06, y = -1603.26, z = 29.75, model = -2050014543, locked = true, offset={0.0, 0.8, 0.0}, heading=230, _dist = 1.5, allowedJobs = {"sheriff","corrections"}},
  {name = "DavisPD_GymRoom_Entrance", x = 373.62, y = -1606.04, z = 29.75, model = -1121275541, locked = true, offset={0.0, 1.2, 0.0}, heading=320, _dist = 1.5, allowedJobs = {"sheriff","corrections"}},
  {name = "DavisPD_GymRoom_SideEntrance", x = 368.38, y = -1613.56, z = 29.75, model = -2050014543, locked = true, offset={0.0, 0.8, 0.0}, heading=230, _dist = 1.5, allowedJobs = {"sheriff","corrections"}},
  {name = "DavisPD_LockerRoom", x = 377.81, y = -1617.8, z = 29.75, model = -1121275541, locked = true, offset={0.0, 1.2, 0.0}, heading=320, _dist = 1.5, allowedJobs = {"sheriff","corrections"}},
  {name = "DavisPD_BackhallEntrance_LeftDoor", x = 376.75, y = -1607.97, z = 29.75, model = -1550418369, locked = true, offset={0.0, 0.8, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_BackhallEntrance_RightDoor", x = 375.23, y = -1606.69, z = 29.75, model = -1550418369, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {"sheriff","corrections"}, static = true, gate = true, lockedCoords = {375.23, -1606.69, 29.75}},
  {name = "DavisPD_MainHallEntrance_LeftDoor", x = 385.06, y = -1617.23, z = 29.75, model = -1550418369, locked = true, offset={0.0, 0.8, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_MainHallEntrance_RightDoor", x = 383.54, y = -1615.95, z = 29.75, model = -1550418369, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {"sheriff","corrections"}, static = true, gate = true, lockedCoords = {383.54, -1615.95, 29.75}},
  {name = "DavisPD_ArmoryRoom", x = 380.38, y = -1629.18, z = 29.75, model = -1121275541, locked = true, offset={0.0, 1.2, 0.0}, heading=140, _dist = 1.5, allowedJobs = {"sheriff","corrections"}},
  {name = "DavisPD_CarLot_ExteriorEntrance_LeftDoor", x = 375.72, y = -1629.94, z = 29.92, model = -565696197, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {"sheriff","corrections"}},
  {name = "DavisPD_CarLot_ExteriorEntrance_RightDoor", x = 377.01, y = -1628.41, z = 29.92, model = 1665053474, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {"sheriff","corrections"}, static = true, gate = true, lockedCoords = {377.01, -1628.41, 29.92}},
  {name = "DavisPD_EvidenceCage_Door", x = 376.93, y = -1602.05, z = 25.35, model = -546449684, locked = true, offset={0.0, 1.0, 0.0}, heading=185, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_FileRoom_RightDoor", x = 371.31, y = -1601.24, z = 25.35, model = -2050014543, locked = true, offset={0.0, 1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}, static = true, gate = true, lockedCoords = {371.31, -1601.24, 25.35}},
  {name = "DavisPD_FileRoom_LeftDoor", x = 370.02, y = -1602.77, z = 25.35, model = -2050014543, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_EntryOne", x = 382.15, y = -1620.78, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_SharedHoldingCell", x = 387.18, y = -1621.35, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_MugShotRoom", x = 385.76, y = -1625.33, z = 24.7, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_CellHall", x = 391.95, y = -1625.36, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_one", x = 393.94, y = -1624.95, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_two", x = 396.12, y = -1622.37, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_three", x = 394.14, y = -1618.72, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_four", x = 398.29, y = -1619.78, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_five", x = 400.46, y = -1617.2, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_six", x = 402.64, y = -1614.62, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_seven", x = 400.1, y = -1611.64, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_eight", x = 404.81, y = -1612.03, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_nine", x = 402.28, y = -1609.06, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_ten", x = 405.03, y = -1609.3, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_CellArea_EntryTwo", x = 395.94, y = -1614.03, z = 24.86, model = 1291451476, locked = true, offset={0.0, -1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_LineUp", x = 390.55, y = -1611.0, z = 25.36, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_LowerArmory", x = 386.19, y = -1601.25, z = 25.36, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_ObservationOne", x = 388.69, y = -1603.92, z = 25.36, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_ObservationTwo", x = 393.54, y = -1598.15, z = 25.36, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_InterrogationOne", x = 394.92, y = -1605.83, z = 25.36, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_InterrogationTwo", x = 399.77, y = -1600.07, z = 25.36, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_Identification", x = 385.19, y = -1608.08, z = 25.36, model = -622203671, locked = true, offset={0.0, 1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_PatrolReception_Entrance", x = 385.44, y = -1618.81, z = 29.77, model = 1091615029, locked = true, offset={0.0, 1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_ImpoundEntrance_RightDoor", x = 387.72, y = -1637.26, z = 29.92, model = -565696197, locked = true, offset={0.0, -1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}, static = true, gate = true, lockedCoords = {387.72, -1637.26, 29.92}},
  {name = "DavisPD_ImpoundEntrance_LeftDoor", x = 386.43, y = -1638.79, z = 29.92, model = 1665053474, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_ImpoundReception", x = 385.13, y = -1633.76, z = 29.77, model = 1091615029, locked = true, offset={0.0, 1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_ImpoundRecptionArea_RightDoor", x = 387.83, y = -1635.45, z = 29.75, model = -1550418369, locked = true, offset={0.0, -1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'sheriff','corrections'}, static = true, gate = true, lockedCoords = {387.83, -1635.45, 29.75}},
  {name = "DavisPD_ImpoundRecptionArea_LeftDoor", x = 386.31, y = -1634.17, z = 29.75, model = -1550418369, locked = true, offset={0.0, 1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_SheriffOffice", x = 382.57, y = -1624.96, z = 34.17, model = 1091615029, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_DeputyOffice", x = 386.79, y = -1619.93, z = 34.17, model = 1091615029, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_SecFloorLeft_Right", x = 387.18, y = -1615.12, z = 34.17, model = -1550418369, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}, static = true, gate = true, lockedCoords = {387.18, -1615.12, 34.17}},
  {name = "DavisPD_SecFloorLeft_Left", x = 388.69, y = -1616.4, z = 34.17, model = -1550418369, locked = true, offset={0.0, 1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_DispatchRoom", x = 389.92, y = -1616.21, z = 34.17, model = -1121275541, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_SecFloor_MeetingRoom", x = 376.67, y = -1605.55, z = 34.17, model = -1121275541, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_SecFloorRight_Right", x = 377.28, y = -1606.79, z = 34.17, model = -1550418369, locked = true, offset={0.0, -1.0, 0.0}, heading=140, _dist = 1.5, allowedJobs = {'sheriff','corrections'}, static = true, gate = true, lockedCoords = {377.28, -1606.79, 34.17}},
  {name = "DavisPD_SecFloorRight_Left", x = 378.8, y = -1608.07, z = 34.17, model = -1550418369, locked = true, offset={0.0, 1.0, 0.0}, heading=320, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_OfficeOne", x = 371.56, y = -1612.32, z = 34.17, model = 1091615029, locked = true, offset={0.0, 1.0, 0.0}, heading=50, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_OfficeTwo", x = 372.04, y = -1611.74, z = 34.17, model = 861019576, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
  {name = "DavisPD_OfficeThree", x = 374.65, y = -1608.64, z = 34.17, model = 861019576, locked = true, offset={0.0, 1.0, 0.0}, heading=230, _dist = 1.5, allowedJobs = {'sheriff','corrections'}},
