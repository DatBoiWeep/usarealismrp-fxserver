...
local vehicleShopItems = {
	["vehicles"] = {
		...
		["Muscles"] = {
			{make = "Albany", model = "Buccaneer", price = 68000, hash = -682211828, storage_capacity = 180.0},
			...
			{make = "Declasse", model = "Voodoo", price = 28000, hash = 2006667053, storage_capacity = 180.0},
