local fishItems = {
  {name = "Trout", quantity = 1, worth = 200, type = "fish", weight = 5, legality = "legal"},
  {name = "Flounder", quantity = 1, worth = 300, type = "fish", weight = 5, legality = "legal"},
  {name = "Halibut", quantity = 1, worth = 425, type = "fish", weight = 5, legality = "legal"}
}

local seaFishItems = {
  {name = "Yellowfin Tuna", quantity = 1, worth = 550, type = "seafish", weight = 15, legality = "legal"},
  {name = "Swordfish", quantity = 1, worth = 650, type = "seafish", weight = 20, legality = "legal"}
}
