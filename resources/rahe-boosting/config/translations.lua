translations = {
    ...
    NOTIFICATION_TABLET_ORDER_SUCCESSFUL = "Order successful. You can pick up your goods from the autoshop down at the docks. The order won't be there for long!",
